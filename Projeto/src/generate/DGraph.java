...
public class DGraph{
	...
	// A fazer:
		...
		// 2. Continuar esses caminhos com todos os possíveis loops contendo i. - uma funcao
		...
		// (no final tem de se retirar o nó i do final do caminho, porque no BGP o no i recebe esse caminho com excecao dele proprio.)
